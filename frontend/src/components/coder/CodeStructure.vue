<template>
  <div class="panel">
    <div class="panel-header"><i class="fas fa-sitemap"></i> 代码结构 · 手写渲染台</div>
    <div class="code-structure-body">
...
.panel-header i { color:#22c55e; margin-right:8px; }
.code-structure-body { flex:1; display:grid; grid-template-columns:1fr 1fr; gap:16px; min-height:0; }
